...
class MMM_App:
    ...
    def show_results(self):
        ...
        with tab3:  # ROAS анализ            
            ...
            st.markdown("ROAS = 3.0 означает, что каждый рубль рекламы генерирует 3 рубля дополнительной выручки")
            st.markdown("ROAS = 1.0 — точка безубыточности (реклама окупает себя)")
            st.markdown("ROAS < 1.0 — убыточные инвестиции с позиции краткосрочной окупаемости")
            
            st.markdown("**Методологические особенности в MMM:**")
        ...
        with tab4:
            ...
            with st.expander("❓ Что такое кривые насыщения?", expanded=True):
               ...
               st.markdown("📈 **Что показывает кривая:**")
               ...
               st.markdown("💡 **Практическое применение:**")
